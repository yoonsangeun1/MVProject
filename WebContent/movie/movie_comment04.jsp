...
<%-- <p style="font-size:11px; color: blue; font-family: '맑은 고딕';"></p> --%>
	...
	<div id="movie_comment">
		...
		<div id="video">
			...
			<iframe width="1186" height="500" src="https://www.youtube.com/embed/tEOs9CktCoQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			
		</div>
	
		<%-- 영상 기본 정보 --%>
		<div id="videoInfo">
			<h5>고양이들이 너무 좋아해서 2층 침대를 선물했어요</h5>
			<p style="font-size: 9px; color: gray; font-family: '맑은 고딕';">조회 수 1,315,011회·2018.04.27.<p>
			<hr />
			...
			<p style="font-size: 10px; color: black; font-family: '맑은 고딕';">고양이들이 2층 침대를 너무 좋아해서 아지트로 만들어 주기로 했어요.<br />
			똥고양이들</p>
		</div>
		...
		<div id="anothervideo">
			...
			<div id="anovi3">
				...
				<a href="movie_cont.jsp"><img src="../images/vod3.PNG" width="300px" height="160px" /></a>
			</div>
		</div>
	</div>
</body>
