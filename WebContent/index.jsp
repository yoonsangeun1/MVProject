			...
			<div id="bannermain_wrap">
				...
				<div id="biMoving_wrap">
					...
					<div class="biMoving_button">
						<input type="button" id="biMoving_aboutMoving"
							value="MOVING 자세히보기"
							onclick="location='./banner/aboutMoving.jsp';" />
					</div>
				</div>
				...
				<div id="biSns_wrap">
					<div class="biSns_x">
						...
						<div class="biSns_text">
							<h3>MOVING만의 SNS서비스</h3>
						</div>
						<div class="biSns_button">
							<a href="#"><img src="./images/snsmore.png" width="200"
								height="50" alt="learnmore"></a>
						</div>
					</div>
				</div>
				...
				<div id="biProject_wrap">
					...
					<div class="biProject_button">
						<input type="button" id="biProject_actorButton" value="배우모집 게시판"
							onclick="location='#';" /> <input type="button"
							id="biProject_writerButton" value="작가모집 게시판"
							onclick="location='#';" /> <input type="button"
							id="biProject_songwriterButton" value="음향제작자 모집 게시판"
							onclick="location='#';" />
					</div>
				</div>
				...
				<div id="biSupport_wrap">
					...
					<div class="biSupport_logo">
						<img src="./images/header_logo.png" width="200" height="100"
							alt="support_logo" />
					</div>
				...
				<div id="biTeaser_wrap">
					...
					<div class="biTeaser_logo">
						<img src="#" width="150" height="150" alt="teaser_logo" />
					</div>
					<div class="biTeaser_text">
						<h3>티저 페이지 설명</h3>
					</div>
					<iframe name="teaser_play"
						src="https://www.youtube.com/embed/Z7TvYBByCLM?autoplay=1"
						frameborder="0" align="left"> </iframe>

					<input type="button" id="biTeaser_button" value="티저 게시판"
						onclick="location='#';" />
				</div>
				...
				<div id="biBoard_wrap">
					...
					<div class="biBoard_logo">
						<img src="#" width="150" height="150" alt="board_logo" />
					</div>
					<div class="biBoard_text">
						<h3>게시판 페이지 설명</h3>
					</div>
					<div class="biBoard_button">
						<input type="button" id="biBoard_goBoard" value="게시판 이동"
							onclick="location='#';" />
					</div>
				</div>
				...
				<div id="biStatistics_wrap">
					...
					<div class="biStatistics_logo">
						<img src="#" width="150" height="150" alt="statistics_logo" />
					</div>
					<div class="biStatistics_text">
						<h3>금액 및 통계 페이지 설명</h3>
					</div>
					<div class="biStatistics_button">
						<input type="button" id="biBoard_goStatistics"
							value="금액 및 통계페이지 이동" onclick="location='#';" />
					</div>
				</div>
			</div>
