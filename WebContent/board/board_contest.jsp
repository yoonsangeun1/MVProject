...
<body>
  ...
  tbody나 tfoot 보다 먼저 위치.  --%>
	...
	<div id="bContest_writing"> <%-- 글 쓰기 폼 div --%>
      <input type="button" id="bContest_writing_btn" name="bContest_writing_btn"
      value="글 쓰기" />
    </div> <%-- 글 쓰기 폼 div --%>
		...
		<div id="bContest_pagination"> <%--페이지 순번 --%>
		 <a href="board_contest.jsp">첫페이지</a>
		 <a href="board_contest.jsp">&lt;&lt;</a>
		 <a href="board_contest.jsp">1</a>
		 <a href="board_contest.jsp">2</a>
		 <a href="board_contest.jsp">3</a>
		 <a href="board_contest.jsp">4</a>
		 <a href="board_contest.jsp">5</a>
		 <a href="board_contest.jsp">6</a>
		 <a href="board_contest.jsp">7</a>
		 <a href="board_contest.jsp">8</a>
		 <a href="board_contest.jsp">9</a>
		 <a href="board_contest.jsp">10</a>
		 <a href="board_contest.jsp">&gt;&gt;</a>
		 <a href="board_contest.jsp">끝페이지</a>
		</div>
