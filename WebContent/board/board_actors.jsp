  ...
  <div id="bActors_panel" > <%--연기자 프로필 주의사항 --%>
   <h3>연기자 프로필</h3>
    <div id="bActors_panelbody"> <%--주의사항 글 --%>
     ...
     <br/>
     -이곳에 등록된 연기자를 MOVING에서 매니지먼트 하는게 아닙니다. 직접 연락하시면 됩니다.
     <br/>
   ...
   <div> <%-- 밑 전체 div --%>
    ...
    <div id="bActors_page"> <%--페이지 순번 --%>
		 ...
		 <a href="board_actors.jsp">&lt;&lt;</a>
		 <a href="board_actors.jsp">1</a>
		 <a href="board_actors.jsp">2</a>
		 <a href="board_actors.jsp">3</a>
		 <a href="board_actors.jsp">4</a>
		 <a href="board_actors.jsp">5</a>
		 <a href="board_actors.jsp">6</a>
		 <a href="board_actors.jsp">7</a>
		 <a href="board_actors.jsp">8</a>
		 <a href="board_actors.jsp">9</a>
		 <a href="board_actors.jsp">10</a>
		 <a href="board_actors.jsp">&gt;&gt;</a>
